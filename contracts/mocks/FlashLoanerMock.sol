...
contract FlashLoanerMock is IERC3156FlashBorrower, IERC3156BatchFlashBorrower{
    using BoringMath for uint256;
    using BoringERC20 for IERC20;

    function onBatchFlashLoan(
        address sender, IERC20[] calldata tokens, uint256[] calldata amounts, uint256[] calldata fees, bytes calldata
    ) external override {
    ...
    function onFlashLoan(address sender,
        IERC20 token,
        uint256 amount,
        uint256 fee,

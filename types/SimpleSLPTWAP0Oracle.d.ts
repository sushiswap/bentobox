...
interface SimpleSLPTWAP0OracleInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleSLPTWAP0Oracle extends Contract {
  ...
  interface: SimpleSLPTWAP0OracleInterface;

...
interface SushiSwapFactoryMockInterface extends ethers.utils.Interface {
  functions: {
...
export class SushiSwapFactoryMock extends Contract {
  ...
  interface: SushiSwapFactoryMockInterface;

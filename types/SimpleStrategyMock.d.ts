...
interface SimpleStrategyMockInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleStrategyMock extends Contract {
  ...
  interface: SimpleStrategyMockInterface;

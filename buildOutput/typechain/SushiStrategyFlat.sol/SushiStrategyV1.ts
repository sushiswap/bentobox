...
export interface SushiStrategyV1Interface extends utils.Interface {
  contractName: "SushiStrategyV1";
...
export interface SushiStrategyV1 extends BaseContract {
  contractName: "SushiStrategyV1";
  ...
  interface: SushiStrategyV1Interface;

...
async function balances(thisObject, token, address) {
  ...
  let txt = "Free: " + (await token.balanceOf(address)).toString() + " - " +
    "Bento Share: " + (await thisObject.bentoBox.balanceOf(token.address, address)).toString()
...
async function debugInfo(thisObject) {
  ...
  console.log("Pair Collateral in Bento", (await thisObject.bentoBox.balanceOf(thisObject.a.address, thisObject.pairAB.contract.address)).toString());
  console.log();
  ...
  console.log("Pair Asset in Bento", (await thisObject.bentoBox.balanceOf(thisObject.b.address, thisObject.pairAB.contract.address)).toString());
  console.log();

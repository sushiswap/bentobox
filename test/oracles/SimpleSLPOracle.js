...
describe("SimpleSLPOracle", function () {
  ...
  beforeEach(async function () {
    ...
    this.collateral = await this.ReturnFalseERC20.deploy("Token A", "A", e18("10000000"))
    await this.collateral.deployed()

    this.asset = await this.RevertingERC20.deploy("Token B", "B", e18("10000000"))
    ...
    describe("get", function (){
        it("should update and get prices within period", async function() {
            ...
            expect((await this.oracle.peek(this.oracleData))[1]).to.be.equal(e18(1).mul(5).div(10))
        })
